  ...
  return (
    <div className="max-w-3xl mx-auto p-6 md:p-8 bg-white dark:bg-zinc-950 border border-foreground/10 rounded-3xl shadow-xl shadow-foreground/5">
      <div className="mb-6 text-center md:text-left">
        <h1 className="text-2xl font-black bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">🐾 Add a New Pet</h1>
        <p className="text-xs text-foreground/60 mt-1 font-medium">আশ্রয়হীন কোনো প্রাণীর নতুন জীবনের ব্যবস্থা করতে নিচের প্রয়োজনীয় তথ্যগুলো দিন।</p>
      </div>

      <form onSubmit={onSubmit} className="space-y-4 text-foreground">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Pet Name *</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Species *</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Breed *</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Age *</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Gender *</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Image URL *</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Health Status *</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Vaccination Status *</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Location *</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="font-bold text-xs text-foreground/70">Adoption Fee (BDT) *</label>
        ...
        <div className="flex flex-col gap-1">
          <label className="font-bold text-xs text-foreground/70">Description / Pet Story *</label>
        ...
        <div className="flex flex-col gap-1">
          <label className="font-bold text-xs text-foreground/40">Owner Email (Read Only)</label>
